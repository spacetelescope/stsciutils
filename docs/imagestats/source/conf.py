...
sys.path.insert(0, os.path.abspath('../stsciutils/imagestats'))
...
import stsciutils.imagestats
release = "{:s} ({:s})".format(stsciutils.imagestats.__version__,
                               stsciutils.imagestats.__version_date__)
...
htmlhelp_basename = 'imagestatsdoc'
...
latex_documents = [
  ('index', 'imagestats.tex', u'stsciutils.imagestats Documentation',
   author, 'manual'),
]
...
man_pages = [
    ('index', 'imagestats', u'stsciutils.imagestats Documentation',
     [author], 1)
]
...
texinfo_documents = [
  ('index', 'imagestats.tex', u'stsciutils.imagestats Documentation',
   author, 'index', 'stsciutils.imagestats Documentation',
   'Miscellaneous'),
]
...
epub_title = u'imagestats'
epub_author = author
epub_publisher = u'STScI'
epub_copyright = copyright

# The basename for the epub file. It defaults to the project name.
# epub_basename = u'imagestats'
